...
def test_sliced_wasserstein_basic():
    ...
    dgm1 = torch.tensor([[0.0, 1.0], [0.5, 2.0]], dtype=torch.float64, requires_grad=True)
    dgm2 = torch.tensor([[0.2, 1.2], [0.6, 2.1]], dtype=torch.float64, requires_grad=True)
...
def test_sliced_wasserstein_identical():
    ...
    dgm = torch.tensor([[0.0, 1.0], [0.5, 2.0], [1.0, 3.0]], dtype=torch.float64)
...
def test_sliced_wasserstein_symmetry():
    ...
    dgm1 = torch.tensor([[0.0, 1.0], [0.5, 2.0], [1.0, 1.5]], dtype=torch.float64)
    dgm2 = torch.tensor([[0.2, 1.2], [0.6, 2.1]], dtype=torch.float64)
    ...
    assert dist_12.item() == pytest.approx(dist_21.item(), abs=1e-10)


def test_sliced_wasserstein_differentiable():
    """Test that gradients flow back through sliced Wasserstein."""
    dgm1 = torch.tensor([[0.0, 1.0], [0.5, 2.0], [1.0, 3.0]], dtype=torch.float64, requires_grad=True)
    dgm2 = torch.tensor([[0.2, 1.2], [0.6, 2.1], [1.1, 3.1]], dtype=torch.float64, requires_grad=True)
...
def test_sliced_wasserstein_gradient_descent():
    ...
    target = torch.tensor([[0.0, 1.0], [0.5, 2.0]], dtype=torch.float64)
    dgm = torch.tensor([[0.5, 1.5], [1.0, 2.5]], dtype=torch.float64, requires_grad=True)
...
def test_sliced_wasserstein_with_essential_points():
    ...
    dgm1 = torch.tensor([[0.0, 1.0], [0.5, float('inf')]], dtype=torch.float64, requires_grad=True)
    dgm2 = torch.tensor([[0.2, 1.2], [0.6, float('inf')]], dtype=torch.float64, requires_grad=True)
...
def test_sliced_wasserstein_ignore_inf_points():
    ...
    dgm1 = torch.tensor([[0.0, 1.0], [0.5, 2.0], [1.0, float('inf')]], dtype=torch.float64)
    dgm2 = torch.tensor([[0.2, 1.2], [0.6, 2.1], [1.2, float('inf')]], dtype=torch.float64)
...
def test_essential_cardinality_mismatch():
    ...
    dgm1 = torch.tensor([[0.0, 1.0], [0.5, float('inf')]], dtype=torch.float64)
    dgm2 = torch.tensor([[0.2, 1.2], [0.6, float('inf')], [1.0, float('inf')]], dtype=torch.float64)
...
def test_compare_standard_vs_corrected():
    ...
    dgm1 = torch.tensor([[0.0, 1.0], [0.5, 2.0], [1.0, 3.0]], dtype=torch.float64)
    dgm2 = torch.tensor([[0.2, 1.2], [0.6, 2.1]], dtype=torch.float64)
