...
void init_oineus_fil_dgm_simplex(py::module& m)
{
    ...
    py::class_<Filtration>(m, filtration_class_name.c_str())
            ...
            .def("__getitem__", [](Filtration& fil, size_t i) { return fil.get_cell(i);})
            ...
            .def("boundary_matrix", &Filtration::boundary_matrix, py::arg("n_threads"))
            .def("boundary_matrix_in_dimension", &Filtration::boundary_matrix_in_dimension, py::arg("dim"), py::arg("n_threads"))
            .def("coboundary_matrix", &Filtration::coboundary_matrix, py::arg("n_threads"))
