...
#o> eps= 1.0912933401365952
#o> step_idx = 0, loss = tensor(19.0054, grad_fn=<SumBackward0>), dgm_loss = tensor(2.0579, grad_fn=<SumBackward0>)
#o> eps= 0.9668095554914753
#o> step_idx = 1, loss = tensor(16.0482, grad_fn=<SumBackward0>), dgm_loss = tensor(1.6663, grad_fn=<SumBackward0>)
#o> eps= 0.8213779811632533
#o> step_idx = 2, loss = tensor(14.8628, grad_fn=<SumBackward0>), dgm_loss = tensor(1.2948, grad_fn=<SumBackward0>)
#o> eps= 0.6736735727389156
#o> step_idx = 3, loss = tensor(13.7685, grad_fn=<SumBackward0>), dgm_loss = tensor(0.9628, grad_fn=<SumBackward0>)
#o> eps= 0.5844070224149236
#o> step_idx = 4, loss = tensor(11.4909, grad_fn=<SumBackward0>), dgm_loss = tensor(0.7818, grad_fn=<SumBackward0>)
